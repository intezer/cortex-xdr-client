...
class AlertV2(CustomBaseModel):
    ...
    starred: bool | None = None
    deduplicate_tokens: str | None = None
    filter_rule_id: list[str | None] | None = None
    mitre_technique_id_and_name: list[str | None] | None = None
    mitre_tactic_id_and_name: list[str | None] | None = None
    agent_version: str | None = None
    agent_ip_addresses_v6: list[str | None] | None = None
    agent_device_domain: str | None = None
    agent_fqdn: str | None = None
    agent_os_type: str | None = None
    agent_os_sub_type: str | None = None
    ...
    agent_install_type: str | None = None
    agent_host_boot_time: list[int | None] | None = None
    event_sub_type: list[int | None] | None = None
    module_id: list[str | None] | None = None
    association_strength: list[int | None] | None = None
    dst_association_strength: list[int | None] | None = None
    story_id: list[str | None] | None = None
    event_id: list[str | None] | None = None
    event_type: list[str | int | None] | None = None
    event_timestamp: list[int | None] | None = None
    actor_process_instance_id: list[str | None] | None = None
    actor_process_image_path: list[str | None] | None = None
    actor_process_image_name: list[str | None] | None = None
    actor_process_command_line: list[str | None] | None = None
    actor_process_signature_status: list[str | None] | None = None
    actor_process_signature_vendor: list[str | None] | None = None
    actor_process_image_sha256: list[str | None] | None = None
    actor_process_image_md5: list[str | None] | None = None
    actor_process_causality_id: list[str | None] | None = None
    actor_causality_id: list[str | None] | None = None
    actor_process_os_pid: list[int | None] | None = None
    actor_thread_thread_id: list[int | None] | None = None
    causality_actor_process_image_name: list[str | None] | None = None
    causality_actor_process_command_line: list[str | None] | None = None
    causality_actor_process_image_path: list[str | None] | None = None
    causality_actor_process_signature_vendor: list[str | None] | None = None
    causality_actor_process_signature_status: list[str | None] | None = None
    causality_actor_causality_id: list[str | None] | None = None
    causality_actor_process_execution_time: list[int | None] | None = None
    causality_actor_process_image_md5: list[str | None] | None = None
    causality_actor_process_image_sha256: list[str | None] | None = None
    action_file_path: list[str | None] | None = None
    action_file_name: list[str | None] | None = None
    action_file_md5: list[str | None] | None = None
    action_file_sha256: list[str | None] | None = None
    action_file_macro_sha256: list[str | None] | None = None
    action_registry_data: list[str | None] | None = None
    action_registry_key_name: list[str | None] | None = None
    action_registry_value_name: list[str | None] | None = None
    action_registry_full_key: list[str | None] | None = None
    action_local_ip: list[str | None] | None = None
    action_local_ip_v6: list[str | None] | None = None
    action_local_port: list[int | None] | None = None
    action_remote_ip: list[str | None] | None = None
    action_remote_ip_v6: list[str | None] | None = None
    action_remote_port: list[int | None] | None = None
    action_external_hostname: list[str | None] | None = None
    action_country: list[str | None] | None = None
    action_process_instance_id: list[str | None] | None = None
    action_process_causality_id: list[str | None] | None = None
    action_process_image_name: list[str | None] | None = None
    action_process_image_sha256: list[str | None] | None = None
    action_process_image_command_line: list[str | None] | None = None
    action_process_signature_status: list[str | None] | None = None
    action_process_signature_vendor: list[str | None] | None = None
    os_actor_effective_username: list[str | None] | None = None
    os_actor_process_instance_id: list[str | None] | None = None
    os_actor_process_image_path: list[str | None] | None = None
    os_actor_process_image_name: list[str | None] | None = None
    os_actor_process_command_line: list[str | None] | None = None
    os_actor_process_signature_status: list[str | None] | None = None
    os_actor_process_signature_vendor: list[str | None] | None = None
    os_actor_process_image_sha256: list[str | None] | None = None
    os_actor_process_causality_id: list[str | None] | None = None
    os_actor_causality_id: list[str | None] | None = None
    os_actor_process_os_pid: list[int | None] | None = None
    os_actor_thread_thread_id: list[int | None] | None = None
    fw_app_id: list[str | None] | None = None
    fw_interface_from: list[str | None] | None = None
    fw_interface_to: list[str | None] | None = None
    fw_rule: list[str | None] | None = None
    fw_rule_id: list[str | None] | None = None
    fw_device_name: list[str | None] | None = None
    fw_serial_number: list[str | None] | None = None
    fw_url_domain: list[str | None] | None = None
    fw_email_subject: list[str | None] | None = None
    fw_email_sender: list[str | None] | None = None
    fw_email_recipient: list[str | None] | None = None
    fw_app_subcategory: list[str | None] | None = None
    fw_app_category: list[str | None] | None = None
    fw_app_technology: list[str | None] | None = None
    fw_vsys: list[str | None] | None = None
    fw_xff: list[str | None] | None = None
    fw_misc: list[str | None] | None = None
    fw_is_phishing: list[str | None] | None = None
    dst_agent_id: list[str | None] | None = None
    dst_causality_actor_process_execution_time: list[int | None] | None = None
    dns_query_name: list[str | None] | None = None
    dst_action_external_hostname: list[str | None] | None = None
    dst_action_country: list[str | None] | None = None
    dst_action_external_port: list[int | None] | None = None
    is_pcap: bool | None = None
    contains_featured_host: list[str | None] | None = None
    contains_featured_user: list[str | None] | None = None
    contains_featured_ip: list[str | None] | None = None
    image_name: list[str | None] | None = None
    image_id: list[str | None] | None = None
    container_id: list[str | None] | None = None
    container_name: list[str | None] | None = None
    namespace: list[str | None] | None = None
    cluster_name: list[str | None] | None = None
    referenced_resource: list[str | None] | None = None
    operation_name: list[str | None] | None = None
    identity_sub_type: list[str | None] | None = None
    identity_type: list[str | None] | None = None
    project: list[str | None] | None = None
    cloud_provider: list[str | None] | None = None
    resource_type: list[str | None] | None = None
    resource_sub_type: list[str | None] | None = None
    user_agent: list[str | None] | None = None
    alert_type: str | None = None
    resolution_status: str | None = None
    resolution_comment: str | None = None
    dynamic_fields: dict | None = None
    tags: list[str | None] | None = None
    malicious_urls: list[str | None] | None = None
    alert_id: str | None = None
    detection_timestamp: int | None = None
    name: str | None = None
    category: str | None = None
    ...
    host_ip: list[str | None] | None = None
    host_name: str | None = None
    action: str | None = None
    source: str | None = None
    original_tags: list[str | None] | None = None
    user_name: list[str | None] | None = None
    ...
    @field_validator('event_type', mode='before')
    @classmethod
    def normalize_event_type(cls, value: list[str | int | None] | None) -> list[str | None] | None:
        """Normalize event_type during validation to ensure consistent types."""
        if value is None:
            return None
    ...
    @field_validator('host_ip',
                     ...
                     mode='before')
    @classmethod
    def _split_comma_separated_string_to_list(cls, value: str | list[str | None] | None) -> list[str | None] | None:
        if value is None:
            return None
        if isinstance(value, str):
            return [item.strip() for item in value.split(',') if item.strip()]
