...
from cortex_xdr_client.api.models.exceptions import (
...
class XQLAPI(BaseAPI):
    ...
    def _get_xql_results_filter(
        self, query_id: str, limit: int = None, params: dict = {}
    ) -> dict:
    ...
    def get_query_results_stream(self, stream_id: str) -> dict | None:
        """
        Returns the results of an XQL Query.
